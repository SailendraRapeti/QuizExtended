...
class Quiz9 extends Component<Iprops, Istate> {
  state = {
    checked: '',
    err: '',
  };
  onNext = () => {
    ...
    } else if (checked === 'its acts as a breakpoint in a program') {
...
What does the Javascript “debugger” statement do?
          ...
          <View style={style.radio}>
            <RadioButton
              value="it will debug all errors"
              status={
                this.state.checked === 'it will debug all errors'
                  ? 'checked'
                  : 'unchecked'
              } //if the value of checked is Apple, then select this button
              onPress={() => this.setState({checked: 'it will debug all errors'})} //when pressed, set the value of the checked Hook to 'Apple'
            />
            <Text
              style={{
                padding: 5,
 ...
 it will debug all errors
            </Text>
          </View>
          <View style={style.radio}>
            <RadioButton
              value="its acts as a breakpoint in a program"
              status={
                this.state.checked === 'its acts as a breakpoint in a program'
                  ? 'checked'
                  : 'unchecked'
              }
              onPress={() => this.setState({checked: 'its acts as a breakpoint in a program'})}
            />
            <Text
              style={{
                padding: 5,
...
its acts as a breakpoint in a program
            </Text>
          </View>
          <View style={style.radio}>
            <RadioButton
        ...
        <View style={style.but}>
          ...
          <View style={style.bottonns}>
            <TouchableHighlight
              onPress={() => this.props.navigation.navigate('Quiz8')}>
