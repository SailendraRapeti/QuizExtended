...
class Quiz8 extends Component<Iprops, Istate> {
  state = {
    checked: '',
    err: '',
  };
      ...
      <View style={style.mainContainer}>
        ...
        <View style={{padding: 20}}>
          ...
          <View style={style.radio}>
            <RadioButton
              value="object"
              status={
                this.state.checked === 'object'
                  ? 'checked'
                  : 'unchecked'
              } //if the value of checked is Apple, then select this button
              onPress={() => this.setState({checked: 'object'})} //when pressed, set the value of the checked Hook to 'Apple'
            />
            <Text
              style={{
                padding: 5,
         ...
         object
          ...
          <View style={style.radio}>
            <RadioButton
              ...
              onPress={() => this.setState({checked: 'boolean'})}
            />
            <Text
              style={{
                padding: 5,
        ...
        <View style={style.but}>
          ...
          <View style={style.bottonns}>
            <TouchableHighlight
              onPress={() => this.props.navigation.navigate('Quiz7')}>
